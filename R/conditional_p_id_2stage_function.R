#' Function for calculating the conditional probability of identification given
...
conditional_p_id_2stage <- function(relyt, valid, true.score, test.cutoff, nom.cutoff) {
  
  errortrapping(relyt=relyt, valid=valid, test.cutoff=test.cutoff,
